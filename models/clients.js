...
var clientSchema = mongoose.Schema({
    ...
    personalInformation: {
        PI_name: {
            ...
            arabic: {
                PI_firstName_arabic: String,
                PI_secondName_arabic: String,
                PI_thirdName_arabic: String,
                PI_fourthName_arabic: String,
                PI_lastName_arabic: String,
            },
            Farsi: {
                PI_firstName_Farsi: String,
                PI_secondName_Farsi: String,
                PI_thirdName_Farsi: String,
                PI_fourthName_Farsi: String,
                PI_lastName_Farsi: String,
            },
            spanish: {
                PI_firstName_spanish: String,
                PI_secondName_spanish: String,
                PI_thirdName_spanish: String,
                PI_fourthName_spanish: String,
                PI_lastName_spanish: String,
            }
        },
        PI_title: String,
        PI_gender: String,
    ...
    contactData: {
        CD_telephoneNumber: Number,
        CD_mobileNumber: Number,
        CD_postalCode: Number,
        CD_email: String,
